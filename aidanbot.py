...
class AidanBot(commands.Bot):
	...
	def __init__(self, githubrepo:Repository, offline=False):
		self.offline = offline
		self.botrepo = githubrepo

		self.settingup = True
		self.version = "Rewrite Alpha (V2.1) (Slash)"
		self.aidan = 384439774972215296
		self.debug_guilds = [discord.Object(760987756985843733), discord.Object(836936601824788520)]
